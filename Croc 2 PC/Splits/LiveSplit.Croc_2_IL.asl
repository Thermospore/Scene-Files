...
split
{
	...
	// split on crystal acquire for IL
	//if (current.GemCounter == old.GemCounter+1)
	//{return true;}

	// split for race laps
	//if (current.RaceLap == old.RaceLap + 0x1000)
	//{return true;}

	// split for max% inca gg
	if (old.CurLvlCrystals%20 < 20
		&& old.CurLvlCrystals%20 >= 15
		&& current.CurLvlCrystals%20 == 0)
	{return true;}

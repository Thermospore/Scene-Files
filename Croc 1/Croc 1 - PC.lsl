...
<Layout version="1.6.1">
  ...
  <Components>
    ...
    <Component>
      ...
      <Settings>
        <Version>1.5</Version>
        <ScriptPath>D:\Programs\LiveSplit\Components\CrocLOTGV1.asl</ScriptPath>
        <Start>True</Start>
        <Split>True</Split>
        <CustomSettings>
          <Setting id="Split On Level" type="bool">True</Setting>
          <Setting id="Split On Boss/Half World" type="bool">False</Setting>
        </CustomSettings>
      </Settings>
    </Component>
    <Component>
